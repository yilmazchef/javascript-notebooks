...
- Good working knowledge of HyperText Markup Language (HTML) [HTML5 Essentials](https://github.com/yilmazchef/html-notebooks) and
- Its good to know [CSS3 Fundamentals](https://github.com/yilmazchef/css-notebooks)
