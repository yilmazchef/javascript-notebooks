# Javascript notitieboeken

---------------------

JavaScript is een `scripttaal van het web` waarmee je interactiviteit met User-Events kunt doen/toevoegen, voorwaarden en validaties kunt implementeren, dynamische updates in een webpagina kunt uitvoeren, enz. In deze praktische cursus leert u de basisbeginselen van JavaScript programmeren vanuit het niets. We beginnen met wat is JavaScript? Het gebruik, de geschiedenis, hoe schrijf je JavaScript, enz. Het zal ook verschillende programmeer bouwstenen behandelen zoals variabele, functies, array, conditionals, objecten, en nog veel meer.

## Onderwerpen (scheiden met spaties)

---------------------

Voeg onderwerpen toe om je archief te categoriseren en beter vindbaar te maken:
...
## Vereisten voor de huidige cursus / Wat je moet weten

---------------------

Om verder te komen met JavaScript heb je alleen basiskennis nodig van XHTML/HTML. Hier leer je hoe eenvoudig het is om met JavaScript interactiviteit aan een webpagina toe te voegen. Maar, voordat we beginnen, zorg ervoor dat je enige praktische kennis en/of algemeen begrip hebt van:

- Goede werkkennis van HyperText Markup Language (HTML) [HTML5 Essentials](https://github.com/yilmazchef/html-notebooks) en
- Het is goed om te weten [CSS3 Fundamentals](https://github.com/yilmazchef/css-notebooks)
...
Welkom bij onze nieuwe leer-platfoorm! In deze cursus neem ik je mee door de ins en outs van het leren van JavaScript. Deze cursus zal u helpen om de basis van het programmeren met JavaScript scripting taal te leren, van de basis tot geavanceerde onderwerpen stap voor stap.tep.
